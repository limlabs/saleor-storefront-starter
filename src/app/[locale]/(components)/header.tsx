...
export const RootLayoutHeader: FC = () => {
  return (
    <header className="fixed top-0 z-20 grid grid-cols-header-grid  text-lg bg-almost-black text-white justify-items- center items-center h-header-height shadow-vertical-sm w-screen ">
