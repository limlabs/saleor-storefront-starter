...
export default function Sequencing() {
  return (
    <section className="-sm:hidden -lg:w-full  shadow-shadow-white -md:h-1/3 -sm:shadow-none  -lg:h-full  -md:flex -lg:flex flex-col items-center justify-center  mt-0 bg-almost-black   relative">
      <Image
        src={Background}
        alt="background"
        height={600}
        width={1000}
        className="absolute z-10 filter blur-2 brightness-75 shadow-shadow-white border border-white"
      />
