...
export const Contact = () => {
  return (
    <ContentSection className="bg-almost-black flex flex-col items-end -sm:pb-24 -lg:pb-0 w-full">
      <div className="h-96 -lg:bg-forest-green -sm:bg-transparent w-5/6 flex -lg:flex-row -sm:flex-col-reverse -lg:justify-between -lg:shadow-shadow-sm mt-36">
