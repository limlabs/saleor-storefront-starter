...
export default function loading() {
  return (
    <main className="lg:flex lg:justify-between lg:mx-0 mt-4">
      ...
      <section className="lg:w-1/4 px-6 bg-almost-black glass rounded h-96 flex flex-col justify-start ml-2">
        ...
        <div className=" bg-slate-700 rounded-sm h-16"></div>
        <Badge className="mt-5 h-16 w-24 mix-blend-overlay"> </Badge>
      </section>
    </main>
  );
}
